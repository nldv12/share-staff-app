            ...
            <div className={"list"}>
                <div className={"list_el list_el1"}>
                    <div className={"left_side"}>
                        <div className={"list_title"}>Organizacja  “Dbam o Zdrowie”</div>
                ...
                <div className={"list_el list_el2"}>
                    <div className={"left_side"}>
                        <div className={"list_title"}>Organizacja “Dla dzieci”</div>
                ...
                <div className={"list_el list_el3"}>
                    <div className={"left_side"}>
                        <div className={"list_title"}>Organizacja “Bez domu”</div>
